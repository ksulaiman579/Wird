...
class AppLocalizationsTe extends AppLocalizations {
  ...
  @override
  String get appTitle => 'విర్ద్';

  @override
  String get commonContinue => 'కొనసాగించు';

  @override
  String get commonStart => 'ప్రారంభించు';
  ...
  @override
  String get navHadith => 'హదీస్';

  @override
  String get readerContinueReading => 'చదవడం కొనసాగించు';

  @override
  String get readerStartReading => 'చదవడం ప్రారంభించు';
  ...
  String backupLastAuto(String date) {
    return 'చివరి స్వయంచాలక బ్యాకప్: $date';
  }
  ...
  String get settingsMonthlyBackupNotice =>
      'నెలవారీ బ్యాకప్ ఈ పరికరంలో సేవ్ చేయబడింది';
  ...
  @override
  String get navAlManhaj => 'అల్-మన్హజ్';

  @override
  String get headerProfileTooltip => 'ప్రొఫైల్ & సెట్టింగ్‌లు';

  @override
  String get headerRemindersTooltip => 'రిమైండర్‌లు';

  @override
  String get locationTitle => 'స్థానం';

  @override
  String get locationLoading => 'లోడ్ అవుతోంది…';

  @override
  String get locationUseMyLocation => 'నా స్థానాన్ని ఉపయోగించు';

  @override
  String get locationChooseCity => 'నగరాన్ని ఎంచుకోండి';

  @override
  String get locationDetecting => 'గుర్తిస్తోంది…';

  @override
  String get todayMyProgress => 'నా పురోగతి';

  @override
  String get todayGreeting => 'అస్సలాము అలైకుం';

  @override
  String get todayAllDone => 'ఈరోజుకి అంతా పూర్తయింది';

  @override
  String get todayStartSession => 'సెషన్ ప్రారంభించండి';

  @override
  String get todayContinueReading => 'చదవడం కొనసాగించండి';

  @override
  String get todayKeyInsights => 'ముఖ్య సమాచారం';

  @override
  String get exploreTitle => 'అన్వేషించండి';

  @override
  String get exploreSectionDuasAdhkar => 'దుఆలు & అజ్కార్';

  @override
  String get exploreDailyAdhkarTitle => 'రోజువారీ అజ్కార్';

  @override
  String get exploreDailyAdhkarDesc => 'ఉదయం, సాయంత్రం స్మరణ';

  @override
  String get exploreDuaCollectionsTitle => 'దుఆ సేకరణలు';

  @override
  String get exploreDuaCollectionsDesc => 'సందర్భానుసారం దుఆలు';

  @override
  String get moreTitle => 'మరిన్ని';

  @override
  String get moreYourJourney => 'మీ ప్రయాణం';

  @override
  String get moreProgressTitle => 'పురోగతి';

  @override
  String get moreProgressDesc => 'మీ కార్యకలాప పటం, స్ట్రీక్‌లు, మొత్తాలు';

  @override
  String get moreAchievementsTitle => 'విజయాలు';

  @override
  String get moreAchievementsDesc => 'మీ ప్రయాణంలో అన్‌లాక్ అయిన మైలురాళ్లు';

  @override
  String get qiblaTitle => 'ఖిబ్లా';

  @override
  String get zakahTitle => 'జకాత్ కాలిక్యులేటర్';

  @override
  String get tasbihTitle => 'తస్బీహ్';

  @override
  String get quranTitle => 'ఖురాన్';

  @override
  String get quranHubTitle => 'పవిత్ర ఖురాన్';

  @override
  String get progressTitle => 'పురోగతి';

  @override
  String get knowledgeLibraryTitle => 'జ్ఞాన గ్రంథాలయం';

  @override
  String get hadithCollectionsTitle => 'హదీస్ సేకరణలు';

  @override
  String get searchTitle => 'వెతకండి';

  @override
  String get hadithNawawiTitle => 'అన్-నవవీ యొక్క 40 హదీసులు';

  @override
  String get duasTitle => 'దుఆలు';

  @override
  String get namesOfAllahTitle => 'అల్లాహ్ యొక్క 99 పేర్లు';

  @override
  String get libraryTitle => 'గ్రంథాలయం';

  @override
  String get alManhajTitle => 'అల్-మన్హజ్';
  ...
  @override
  String get downloadsTitle => 'డౌన్‌లోడ్‌లు';

  @override
  String get celebrationPortionComplete => 'ఈరోజు భాగం పూర్తయింది!';

  @override
  String get exploreSectionStudy => 'అధ్యయనం & సూచన';
