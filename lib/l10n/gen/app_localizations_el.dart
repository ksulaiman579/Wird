...
class AppLocalizationsEl extends AppLocalizations {
  ...
  @override
  String get navQuran => 'Κοράνι';

  @override
  String get navHadith => 'Χαντίθ';

  @override
  String get readerContinueReading => 'Συνέχιση ανάγνωσης';

  @override
  String get readerStartReading => 'Έναρξη ανάγνωσης';
  ...
  String backupLastAuto(String date) {
    return 'Τελευταίο αυτόματο αντίγραφο: $date';
  }
  ...
  @override
  String get settingsBackup => 'Αντίγραφο ασφαλείας';

  @override
  String get settingsMonthlyBackupNotice =>
      'Το μηνιαίο αντίγραφο ασφαλείας αποθηκεύτηκε σε αυτή τη συσκευή';
  ...
  @override
  String get headerProfileTooltip => 'Προφίλ και ρυθμίσεις';

  @override
  String get headerRemindersTooltip => 'Υπενθυμίσεις';

  @override
  String get locationTitle => 'Τοποθεσία';

  @override
  String get locationLoading => 'Φόρτωση…';

  @override
  String get locationUseMyLocation => 'Χρήση της τοποθεσίας μου';

  @override
  String get locationChooseCity => 'Επιλογή πόλης';

  @override
  String get locationDetecting => 'Εντοπισμός…';

  @override
  String get todayMyProgress => 'Η πρόοδός μου';

  @override
  String get todayGreeting => 'Ασ-σαλάμου αλάικουμ';

  @override
  String get todayAllDone => 'Όλα έτοιμα για σήμερα';

  @override
  String get todayStartSession => 'Έναρξη συνεδρίας';

  @override
  String get todayContinueReading => 'Συνέχεια ανάγνωσης';

  @override
  String get todayKeyInsights => 'Βασικά στοιχεία';

  @override
  String get exploreTitle => 'Εξερεύνηση';

  @override
  String get exploreSectionDuasAdhkar => 'Ντουά και άντκαρ';

  @override
  String get exploreDailyAdhkarTitle => 'Καθημερινά άντκαρ';

  @override
  String get exploreDailyAdhkarDesc => 'Πρωινή και βραδινή μνήμη';

  @override
  String get exploreDuaCollectionsTitle => 'Συλλογές ντουά';

  @override
  String get exploreDuaCollectionsDesc => 'Δεήσεις ανά περίσταση';

  @override
  String get moreTitle => 'Περισσότερα';

  @override
  String get moreYourJourney => 'Το ταξίδι σου';

  @override
  String get moreProgressTitle => 'Πρόοδος';

  @override
  String get moreProgressDesc =>
      'Ο χάρτης δραστηριότητας, τα σερί και τα σύνολά σου';

  @override
  String get moreAchievementsTitle => 'Επιτεύγματα';

  @override
  String get moreAchievementsDesc => 'Ορόσημα που ξεκλειδώθηκαν στο ταξίδι σου';

  @override
  String get qiblaTitle => 'Κίμπλα';

  @override
  String get zakahTitle => 'Υπολογιστής ζακάτ';

  @override
  String get tasbihTitle => 'Τασμπίχ';

  @override
  String get quranTitle => 'Κοράνι';

  @override
  String get quranHubTitle => 'Το Ιερό Κοράνι';

  @override
  String get progressTitle => 'Πρόοδος';

  @override
  String get knowledgeLibraryTitle => 'Βιβλιοθήκη γνώσης';

  @override
  String get hadithCollectionsTitle => 'Συλλογές χαντίθ';

  @override
  String get searchTitle => 'Αναζήτηση';

  @override
  String get hadithNawawiTitle => '40 χαντίθ του αν-Ναουάουι';

  @override
  String get duasTitle => 'Ντουά';

  @override
  String get namesOfAllahTitle => 'Τα 99 ονόματα του Αλλάχ';

  @override
  String get libraryTitle => 'Βιβλιοθήκη';
  ...
  @override
  String get downloadsTitle => 'Λήψεις';

  @override
  String get celebrationPortionComplete => 'Η σημερινή μερίδα ολοκληρώθηκε!';

  @override
  String get exploreSectionStudy => 'Μελέτη και αναφορά';
