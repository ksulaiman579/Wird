...
class AppLocalizationsKk extends AppLocalizations {
  ...
  @override
  String get navToday => 'Бүгін';

  @override
  String get navQuran => 'Құран';

  @override
  String get navHadith => 'Хадис';

  @override
  String get readerContinueReading => 'Оқуды жалғастыру';

  @override
  String get readerStartReading => 'Оқуды бастау';
  ...
  String backupLastAuto(String date) {
    return 'Соңғы автоматты сақтық көшірме: $date';
  }
  ...
  String get settingsMonthlyBackupNotice =>
      'Айлық сақтық көшірме осы құрылғыда сақталды';

  @override
  String get navHome => 'Басты бет';

  @override
  String get navExplore => 'Зерттеу';
  ...
  @override
  String get navAlManhaj => 'Әл-Манхаж';

  @override
  String get headerProfileTooltip => 'Профиль және параметрлер';

  @override
  String get headerRemindersTooltip => 'Еске салулар';

  @override
  String get locationTitle => 'Орналасқан жері';

  @override
  String get locationLoading => 'Жүктелуде…';

  @override
  String get locationUseMyLocation => 'Менің орнымды пайдалану';

  @override
  String get locationChooseCity => 'Қаланы таңдау';

  @override
  String get locationDetecting => 'Анықталуда…';

  @override
  String get todayMyProgress => 'Менің жетістігім';

  @override
  String get todayGreeting => 'Ассалаумағалейкум';

  @override
  String get todayAllDone => 'Бүгінге бәрі дайын';

  @override
  String get todayStartSession => 'Сабақты бастау';

  @override
  String get todayContinueReading => 'Оқуды жалғастыру';

  @override
  String get todayKeyInsights => 'Негізгі деректер';

  @override
  String get exploreTitle => 'Зерттеу';

  @override
  String get exploreSectionDuasAdhkar => 'Дұғалар мен зікірлер';

  @override
  String get exploreDailyAdhkarTitle => 'Күнделікті зікір';

  @override
  String get exploreDailyAdhkarDesc => 'Таңғы және кешкі зікір';

  @override
  String get exploreDuaCollectionsTitle => 'Дұға жинақтары';

  @override
  String get exploreDuaCollectionsDesc => 'Жағдайға қарай дұғалар';

  @override
  String get moreTitle => 'Тағы';

  @override
  String get moreYourJourney => 'Сіздің жолыңыз';

  @override
  String get moreProgressTitle => 'Жетістік';

  @override
  String get moreProgressDesc =>
      'Белсенділік картаңыз, топтамалар және жиынтық';

  @override
  String get moreAchievementsTitle => 'Жетістіктер';

  @override
  String get moreAchievementsDesc => 'Жолыңызда ашылған кезеңдер';

  @override
  String get qiblaTitle => 'Құбыла';

  @override
  String get zakahTitle => 'Зекет калькуляторы';

  @override
  String get tasbihTitle => 'Тәсбих';

  @override
  String get quranTitle => 'Құран';

  @override
  String get quranHubTitle => 'Қасиетті Құран';

  @override
  String get progressTitle => 'Жетістік';

  @override
  String get knowledgeLibraryTitle => 'Білім кітапханасы';

  @override
  String get hadithCollectionsTitle => 'Хадис жинақтары';

  @override
  String get searchTitle => 'Іздеу';

  @override
  String get hadithNawawiTitle => 'Имам Науауидің 40 хадисі';

  @override
  String get duasTitle => 'Дұғалар';

  @override
  String get namesOfAllahTitle => 'Аллаһтың 99 есімі';

  @override
  String get libraryTitle => 'Кітапхана';

  @override
  String get alManhajTitle => 'Әл-Манхаж';

  @override
  String get achievementsTitle => 'Жетістіктер';

  @override
  String get sessionTitle => 'Сабақ';
  ...
  @override
  String get celebrationPortionComplete => 'Бүгінгі бөлім аяқталды!';

  @override
  String get exploreSectionStudy => 'Оқу және анықтама';
