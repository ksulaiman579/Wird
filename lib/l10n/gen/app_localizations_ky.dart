...
class AppLocalizationsKy extends AppLocalizations {
  ...
  @override
  String get commonContinue => 'Улантуу';

  @override
  String get commonStart => 'Баштоо';

  @override
  String get commonCancel => 'Жокко чыгаруу';

  @override
  String get commonSave => 'Сактоо';

  @override
  String get commonDelete => 'Жок кылуу';

  @override
  String get commonDone => 'Даяр';

  @override
  String get commonClose => 'Жабуу';

  @override
  String get commonSearch => 'Издөө';

  @override
  String get commonSettings => 'Жөндөөлөр';

  @override
  String get navToday => 'Бүгүн';

  @override
  String get navQuran => 'Куран';

  @override
  String get navHadith => 'Хадис';

  @override
  String get readerContinueReading => 'Окууну улантуу';

  @override
  String get readerStartReading => 'Окууну баштоо';

  @override
  String progressStepOf(int current, int total) {
    return 'Кадам $current / $total';
  }
  ...
  String backupLastAuto(String date) {
    return 'Акыркы автоматтык камдык көчүрмө: $date';
  }
  ...
  @override
  String get settingsBackup => 'Камдык көчүрмө';

  @override
  String get settingsMonthlyBackupNotice =>
      'Айлык камдык көчүрмө бул түзмөккө сакталды';
  ...
  @override
  String get navAlManhaj => 'Аль-Манхаж';

  @override
  String get headerProfileTooltip => 'Профиль жана жөндөөлөр';

  @override
  String get headerRemindersTooltip => 'Эскертүүлөр';

  @override
  String get locationTitle => 'Жайгашкан жери';

  @override
  String get locationLoading => 'Жүктөлүүдө…';

  @override
  String get locationUseMyLocation => 'Менин жайгашкан жеримди колдонуу';

  @override
  String get locationChooseCity => 'Шаарды тандоо';

  @override
  String get locationDetecting => 'Аныкталууда…';

  @override
  String get todayMyProgress => 'Менин жетишкендигим';

  @override
  String get todayGreeting => 'Ассаламу алейкум';

  @override
  String get todayAllDone => 'Бүгүнкүгө баары даяр';

  @override
  String get todayStartSession => 'Сабакты баштоо';

  @override
  String get todayContinueReading => 'Окууну улантуу';

  @override
  String get todayKeyInsights => 'Негизги маалымат';

  @override
  String get exploreTitle => 'Изилдөө';

  @override
  String get exploreSectionDuasAdhkar => 'Дубалар жана зикир';

  @override
  String get exploreDailyAdhkarTitle => 'Күнүмдүк зикир';

  @override
  String get exploreDailyAdhkarDesc => 'Эртең менен жана кечки зикир';

  @override
  String get exploreDuaCollectionsTitle => 'Дуба жыйнактары';

  @override
  String get exploreDuaCollectionsDesc => 'Абалга жараша дубалар';

  @override
  String get moreTitle => 'Дагы';

  @override
  String get moreYourJourney => 'Сиздин жолуңуз';

  @override
  String get moreProgressTitle => 'Жетишкендик';

  @override
  String get moreProgressDesc => 'Активдүүлүк картаңыз, катарлар жана жыйынтык';

  @override
  String get moreAchievementsTitle => 'Жетишкендиктер';

  @override
  String get moreAchievementsDesc => 'Жолуңузда ачылган баскычтар';

  @override
  String get qiblaTitle => 'Кыбыла';

  @override
  String get zakahTitle => 'Зекет калькулятору';

  @override
  String get tasbihTitle => 'Тасбих';

  @override
  String get quranTitle => 'Куран';

  @override
  String get quranHubTitle => 'Ыйык Куран';

  @override
  String get progressTitle => 'Жетишкендик';

  @override
  String get knowledgeLibraryTitle => 'Билим китепканасы';

  @override
  String get hadithCollectionsTitle => 'Хадис жыйнактары';

  @override
  String get searchTitle => 'Издөө';

  @override
  String get hadithNawawiTitle => 'Имам Нававийдин 40 хадиси';

  @override
  String get duasTitle => 'Дубалар';

  @override
  String get namesOfAllahTitle => 'Аллахтын 99 ысымы';

  @override
  String get libraryTitle => 'Китепкана';

  @override
  String get alManhajTitle => 'Аль-Манхаж';

  @override
  String get achievementsTitle => 'Жетишкендиктер';

  @override
  String get sessionTitle => 'Сабак';

  @override
  String get aboutTitle => 'Колдонмо жөнүндө';

  @override
  String get downloadsTitle => 'Жүктөөлөр';

  @override
  String get celebrationPortionComplete => 'Бүгүнкү бөлүк аяктады!';

  @override
  String get exploreSectionStudy => 'Окуу жана шилтеме';
