...
mixin _$City {
 ...
 String get name; String get country; String get countryCode; double get lat; double get lng;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,country,countryCode,lat,lng);

@override
String toString() {
  return 'City(name: $name, country: $country, countryCode: $countryCode, lat: $lat, lng: $lng)';
}
...
@useResult
$Res call({
 String name, String country, String countryCode, double lat, double lng
});
...
/// Create a copy of City
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? country = null,Object? countryCode = null,Object? lat = null,Object? lng = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String country,  String countryCode,  double lat,  double lng)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _City() when $default != null:
return $default(_that.name,_that.country,_that.countryCode,_that.lat,_that.lng);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String country,  String countryCode,  double lat,  double lng)  $default,) {final _that = this;
switch (_that) {
case _City():
return $default(_that.name,_that.country,_that.countryCode,_that.lat,_that.lng);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String country,  String countryCode,  double lat,  double lng)?  $default,) {final _that = this;
switch (_that) {
case _City() when $default != null:
return $default(_that.name,_that.country,_that.countryCode,_that.lat,_that.lng);case _:
  return null;
...
class _City implements City {
  const _City({required this.name, required this.country, required this.countryCode, required this.lat, required this.lng});
...
/// Create a copy of City
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? country = null,Object? countryCode = null,Object? lat = null,Object? lng = null,}) {
  return _then(_City(
name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,country: null == country ? _self.country : country // ignore: cast_nullable_to_non_nullable
as String,countryCode: null == countryCode ? _self.countryCode : countryCode // ignore: cast_nullable_to_non_nullable
